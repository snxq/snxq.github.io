...
- Posts use the classic `.github/ISSUE_TEMPLATE/content-post.md`, whose body after front matter must remain empty so GitHub opens a normal full-body Markdown editor without injecting headings or instructions. The Issue title is the post title and the complete Issue body is the Markdown article. Other content types retain their structured Issue Form headings.
